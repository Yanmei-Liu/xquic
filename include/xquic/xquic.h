...
typedef struct xqc_conn_settings_s {
    ...
    /*
     * simulate_ecn: default 0 (false), enable only for experiment/testing.
     * when non-zero, xqc_gen_ack_frame writes ACK_ECN (type 0x03) with
     * dummy ECN counts instead of plain ACK (0x02).
     */
